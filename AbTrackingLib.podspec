...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of AbTrackingLib."
  s.description      = <<-DESC
                       An optional longer description of AbTrackingLib
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/AbTrackingLib.git", :tag => s.version.to_s }
